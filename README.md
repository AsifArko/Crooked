...
| Resource | Purpose |
|----------|---------|
| [`CONTRIBUTING.md`](CONTRIBUTING.md) | How to report issues, propose changes, and open pull requests. |
| [`LICENSE`](LICENSE) | Preview / evaluation only; no commercial use, modification, or reverse engineering (see file). |
